...
export default function EditInvoiceForm({ invoice, customers }: { invoice: InvoiceForm; customers: CustomerField[] }) {
  ...
  const formKey = JSON.stringify(state.payload);
  console.log(state, formKey);
  return (
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue={state.payload?.customerId || invoice.customer_id}
            >
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  defaultChecked={state.payload?.status === "pending" || invoice.status === "pending"}
